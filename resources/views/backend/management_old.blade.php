...
@section('title')
Admin - Management Team Page
@endsection 

@section('content')
<?php $page_name = "management";
...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> Management Team
        ...
        <div class="row">
            <?php $processed_ids = [] ?>
            @foreach($moduleitems as $managementitem)
            <?php $current_id = $managementitem['id']; ?>
            @if(!in_array($managementitem['id'],$processed_ids) && !empty($managementitem['id']))
            <div class="col-md-6">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-green-sharp">
                            ...
                            <span id="management_title" class="caption-subject bold uppercase"> {!!$managementitem['title']!!}</span>
                    ...
                    <div class="portlet-body">
                        <div class="scroller" style="height:200px" data-rail-visible="1" data-rail-color="yellow" data-handle-color="#a1b2bd">
                            <input type="hidden" id="management_id" value="{{$managementitem['id']}}">
                            <input type="hidden" id="type" value="{{$managementitem['type']}}">
                            <input type="hidden" id="management_position" value="{{$managementitem['position']}}">
                            <input type="hidden" id="management_display" value="{{$managementitem['display']}}">
                            <div id="management_details"> {!!$managementitem['details']!!}</div>
                            <div>                                
                                <div class="row">
                                    @foreach($moduleitems as $management_inneritem)
                                    @if($current_id == $management_inneritem['imageid'] && !empty($management_inneritem['imageid']))
                                    <div class="col-sm-6 col-md-3">
                                        <a href="#" class="thumbnail">
                                            <img src="{{asset('/site/img/'.$management_inneritem['filename'])}}" alt="100%x180" style="height: 180px; width: 100%; display: block;">
                                        </a>
                                    </div>
                                    @endif
                                    @endforeach
            ...
            <?php array_push($processed_ids,$managementitem['id'])?>
            @endif
            @endforeach
        ...
        <div class="row">
            <div class="col-md-10">
                ...
                <div class="portlet light portlet-fit portlet-form ">
                    ...
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <form role="form" action="{{ route('processm')}}" method="post" id="management_form" class="form-horizontal" enctype="multipart/form-data">
                            <input type="hidden" name="id"  id="id" value="0">
                            <input type="hidden" name="type"  id="type"  value="management">
                            <div class="form-body">
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <button onclick="resetForm('#management_form');" type="button" class="btn default">Reset</button>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-12">                            
                ...
                <div class="portlet ">
                    ...
                    <div class="portlet-body form">                                    
                        ...
                        <!--full width--> 
                        <div id="management_delete_modal" class="modal fade" tabindex="-1">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                <h4 class="modal-title" id="management_header">Delete Item</h4>
                            </div>
                            <div class="modal-body">
                                <h4>
                                    Are you sure you want to delete this item?
                                </h4>
                                <form role="form" action="{{ route('delete_item')}}" method="post" id="management_delete_form" class="form-horizontal">
