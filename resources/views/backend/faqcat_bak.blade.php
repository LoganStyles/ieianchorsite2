...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="row">
            <?php $processed_ids = [] ?>
            @foreach($moduleitems as $faqcatitem)
            <?php $current_id = $faqcatitem['id']; ?>
            @if(!in_array($faqcatitem['id'],$processed_ids) && !empty($faqcatitem['id']))
            <div class="col-md-6">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-green-sharp">
                            ...
                            <span id="faqcat_title" class="caption-subject bold uppercase"> {!!$faqcatitem['title']!!}</span>
                    ...
                    <div class="portlet-body">
                        <div class="scroller" style="height:200px" data-rail-visible="1" data-rail-color="yellow" data-handle-color="#a1b2bd">
                            <input type="hidden" id="faqcat_id" value="{{$faqcatitem['id']}}">
                            <input type="hidden" id="type" value="{{$faqcatitem['type']}}">
                            <input type="hidden" id="faqcat_position" value="{{$faqcatitem['position']}}">
                            <input type="hidden" id="faqcat_display" value="{{$faqcatitem['display']}}">
                            <!--<div id="faqcat_details"> {!!$faqcatitem['details']!!}</div>-->
                            <div>                                
            ...
            <?php array_push($processed_ids,$faqcatitem['id'])?>
            @endif
            @endforeach
