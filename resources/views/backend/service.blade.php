...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <div class="row">
            <?php $processed_ids = [] ?>
            @foreach($moduleitems as $serviceitem)
            <?php $current_id = $serviceitem['id']; ?>
            @if(!in_array($serviceitem['id'],$processed_ids) && !empty($serviceitem['id']))
            <div class="col-md-6">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-green-sharp">
                            ...
                            <span id="service_title" class="caption-subject bold uppercase"> {{$serviceitem['title']}}</span>
                    ...
                    <div class="portlet-body">
                        <div class="scroller" style="height:200px" data-rail-visible="1" data-rail-color="yellow" data-handle-color="#a1b2bd">
                            <input type="hidden" id="service_id" value="{{$serviceitem['id']}}">
                            <input type="hidden" id="type" value="{{$serviceitem['type']}}">
                            <input type="hidden" id="service_position" value="{{$serviceitem['position']}}">
                            <input type="hidden" id="service_display" value="{{$serviceitem['display']}}">
                            <p id="service_details"> {{$serviceitem['details']}}</p>
                            <div>                                
                                <div class="row">
                                    @foreach($moduleitems as $service_inneritem)
                                    @if($current_id == $service_inneritem['imageid'] && !empty($service_inneritem['imageid']))
            ...
            <?php array_push($processed_ids,$serviceitem['id'])?>
            @endif
            @endforeach
        ...
        <div class="row">
            <div class="col-md-10">
                ...
                <div class="portlet light portlet-fit portlet-form ">
                    ...
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <form role="form" action="{{ route('processm')}}" method="post" id="service_form" class="form-horizontal" enctype="multipart/form-data">
