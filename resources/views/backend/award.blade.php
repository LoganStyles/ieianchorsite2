...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> Award
            <small>Company Awards</small>
        </h3>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
        ...
        <div class="row">
            <?php $processed_ids = []; ?>
            @foreach($moduleitems as $awarditem)
            <?php $current_id = $awarditem['id']; ?>
            @if(!in_array($awarditem['id'],$processed_ids) && !empty($awarditem['id']))
            <div class="col-md-6">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-green-sharp">
                            ...
                            <span id="award_title" class="caption-subject bold uppercase"> {!!$awarditem['title']!!}</span>
                    ...
                    <div class="portlet-body">
                        <div class="scroller" style="height:200px" data-rail-visible="1" data-rail-color="yellow" data-handle-color="#a1b2bd">
                            <input type="hidden" id="award_id" value="{{$awarditem['id']}}">
                            <input type="hidden" id="type" value="{{$awarditem['type']}}">
                            <input type="hidden" id="award_position" value="{{$awarditem['position']}}">
                            <input type="hidden" id="award_display" value="{{$awarditem['display']}}">
                            <div id="award_details"> {!!$awarditem['details']!!}</div>
                            <div>                                
                                <div class="row">
                                    @foreach($moduleitems as $award_inneritem)
                                    @if($current_id == $award_inneritem['imageid'] && !empty($award_inneritem['imageid']))
                                    <div class="col-sm-12 col-md-6">
                                        <a href="#" class="thumbnail">
                                            <img src="{{asset('/site/img/'.$award_inneritem['filename'])}}" alt="100%x180" style="height: 180px; width: 100%; display: block;">
                                        </a>
                                    </div>
                                    @endif
                                    @endforeach
            ...
            <?php array_push($processed_ids,$awarditem['id'])?>
            @endif
            @endforeach
        ...
        <div class="row">
            <div class="col-md-10">
                ...
                <div class="portlet light portlet-fit portlet-form ">
                    ...
                    <div class="portlet-body">
                        <!-- BEGIN FORM-->
                        <form role="form" action="{{ route('processm')}}" method="post" id="award_form" class="form-horizontal" enctype="multipart/form-data">
                            <input type="hidden" name="id"  id="id" value="0">
                            <input type="hidden" name="type"  id="type"  value="award">
                            <div class="form-body">
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <button onclick="resetForm('#award_form');" type="button" class="btn default">Reset</button>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-12">                            
                ...
                <div class="portlet ">
                    ...
                    <div class="portlet-body form">                                    
                        ...
                        <!--full width--> 
                        <div id="award_delete_modal" class="modal fade" tabindex="-1">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                <h4 class="modal-title" id="award_header">Delete Item</h4>
                            </div>
                            <div class="modal-body">
                                <h4>
                                    Are you sure you want to delete this item?
                                </h4>
                                <form role="form" action="{{ route('delete_item')}}" method="post" id="award_delete_form" class="form-horizontal">
