            ...
            <div class="col-md-12">                            
                ...
                <div class="portlet ">
                    ...
                    <div class="portlet-body form">                                    
                        ...
                        <!--full width--> 
                        <div id="article_edit_modal" class="modal fade" tabindex="2" >
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                <h4 class="modal-title" id="article_header">Add/Update Articles</h4>
                            </div>
                            <div class="modal-body">
                                <!-- BEGIN FORM-->
                                <form role="form" action="{{ route('processm')}}" method="post" id="article_form" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="form-body">
                                       ...
                                       @if(session()->has('article') && session('article') >3)
                                       <div class="form-group">
