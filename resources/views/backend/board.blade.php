...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> Board of Directors
            <small>Board</small>
        </h3>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
        ...
        <div class="row">
            <?php $processed_ids = [] ?>
            @foreach($moduleitems as $boarditem)
            <?php $current_id = $boarditem['id']; ?>
            @if(!in_array($boarditem['id'],$processed_ids) && !empty($boarditem['id']))
            <div class="col-md-6">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-green-sharp">
                            ...
                            <span id="board_title" class="caption-subject bold uppercase"> {!!$boarditem['title']!!}</span>
                    ...
                    <div class="portlet-body">
                        <div class="scroller" style="height:200px" data-rail-visible="1" data-rail-color="yellow" data-handle-color="#a1b2bd">
                            <input type="hidden" id="board_id" value="{{$boarditem['id']}}">
                            ...
                            <div>                                
                                <div class="row">
                                    ...
                                    @if($current_id == $board_inneritem['imageid'] && !empty($board_inneritem['imageid']))
                                    <div class="col-sm-12 col-md-6">
                                        <a href="#" class="thumbnail">
                                            <img src="{{asset('/site/img/'.$board_inneritem['filename'])}}" alt="100%x180" style="height: 180px; width: 100%; display: block;">
                                        </a>
                                    </div>
                                    @endif
                                    @endforeach
            ...
            <?php array_push($processed_ids,$boarditem['id'])?>
            @endif
            @endforeach
